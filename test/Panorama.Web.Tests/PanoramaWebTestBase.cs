...
{
    public abstract class PanoramaWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static PanoramaWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(PanoramaWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<PanoramaDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<PanoramaDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<PanoramaDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<PanoramaDbContext, Task<T>> func)
        {
            T result;
